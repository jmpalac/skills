...
description: >
  ...
  without changing what it says. Use when editing or reviewing prose for
  AI tells such as not-X-but-Y contrasts, one-line closers, staged
  openers, forced triads, dashes everywhere, inflated claims, sales
  language, stock AI words, bold labels, or filler. Based on Wikipedia's
  "Signs of AI writing."
---
...
The patterns come from Wikipedia's ["Signs of AI writing"](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), maintained by WikiProject AI Cleanup, and from reviews of AI-generated text on Wikipedia and elsewhere. This skill is adapted from [blader/humanizer](https://github.com/blader/humanizer) (MIT license; see `LICENSE.txt`).
